...
const ResumeSave = () => {
    ...
    let updatesaveresume = "http://localhost:9000/resume/updatesaveresume";
    let callBack = "http://localhost:9000/resume/savedetail?username=" + user_id + "&resume_idx=" + resume_idx; //get일때만 사용가능
