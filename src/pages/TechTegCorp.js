        ...
        <div className={open2 ? 'openModal modal' : 'modal'}  >
            {open2 ? (
                ...
                <main style={{textAlign:'center'}}>
                    <span className='korea' style={{position:"relative", textAlign:'center',width:'400px', height:'50px',fontSize:'1.3rem',margin:'0 auto' }}>
                        
                        <input type='text'  placeholder='검색어를 입력하세요' style={{width:'400px', textAlign:'center', borderRadius:'20px'}} maxLength={15}
                    ...
                    <br></br><br/>
                        ...
                        <b>기술스택을입력하세요</b>
                        <div className='inputst' style={{textAlign:'center',border: '1px solid #6c757d', width:'420px', }}>
                        <ul>
                        {props.newArrTeg &&
                ...
                <footer>
                    ...
                    <button className="close2" onClick={close2} style={{textAlign:'center',borderRadius:'20px', borderbottom:'10px'}}>
                    확인
                    </button>
                </footer>
                </section>
